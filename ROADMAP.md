...
Sprint 1  ████████████████████  100%  ✅
Sprint 2  ████████████████████  100%  ✅
Sprint 3  ████████████████████  100%  ✅ (см. ограничение по модели ниже)
Sprint 4  ░░░░░░░░░░░░░░░░░░░░    0%
Sprint 5  ░░░░░░░░░░░░░░░░░░░░    0%
Sprint 6  ░░░░░░░░░░░░░░░░░░░░    0%
...
**Важное ограничение:** офлайн-модель Vosk (~45 МБ) не включена в репозиторий
и не может быть получена в песочнице сборки этого агента (нет интернета и
Android SDK для сборки/прогона на устройстве). Разработчику нужно вручную
добавить модель в `feature/src/main/assets/model/` перед сборкой — см.
PROJECT_STATE.md. Без модели `VoskModelProvisioner` корректно возвращает
`null`, Debug Screen показывает «Модель не загружена», приложение не падает.
Полный сценарий финальной демонстрации не был прогнан на реальном устройстве
в этой сессии по этой причине — код готов, но конечная проверка на устройстве
за пользователем.

---

## Sprint 4 — Wake Word + журнал (было частью старых Sprint 4/5)

**Цель:** Активационная фраза и более удобная отладка голосового цикла.

- [ ] Активационная фраза ("Диджей, ...") как gate перед Intent Parser —
      архитектура уже готова (`stripWakeWord`/`containsWakeWord` в core)
- [ ] FeedbackManager: звуковые сигналы уже работают (Sprint 1), проверить
      совместно с непрерывным прослушиванием
